...
import com.ifpb30_01_16.projeto_3bimestre.Views.IMCActivity;
 ...
 */
public class ImcAsynctask extends AsyncTask<JSONObject, Void, JSONObject> {
    ...
    protected JSONObject doInBackground(JSONObject... params) {
        ...
        try {
            URL url = new URL("ladoss.com.br:8443/NutrIF_service/calcularIMC");
