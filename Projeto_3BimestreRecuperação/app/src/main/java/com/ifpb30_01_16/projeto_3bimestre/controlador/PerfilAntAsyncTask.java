 ...
 */
public class PerfilAntAsyncTask extends AsyncTask<JSONObject, Void, JSONObject> {
    ...
    public  PerfilAntAsyncTask(Context context){
    ...
    protected JSONObject doInBackground(JSONObject... params) {
        ...
        try {
            URL url = new URL("ladoss.com.br:8443/NutrIF_service/calcularPerfilAntropometrico");
